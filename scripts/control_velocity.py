...
class control_velocity(object):
    def __init__(self):
        ...
        self.linear_pid = PID(250, 50, 0, 100)
        self.angular_pid = PID(10, 150, 0, 10)
        ...
        rospy.Subscriber("/twist", Twist, self.update_duty)

    def update_setpoints(self, cmd_vel):
        self.linear_pid.setpoint = cmd_vel.linear.x
        self.angular_pid.setpoint = cmd_vel.angular.z

    def update_duty(self, twist):
        print(self.linear_pid.setpoint, self.angular_pid.setpoint)
